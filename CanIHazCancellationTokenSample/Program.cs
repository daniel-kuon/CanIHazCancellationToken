...
namespace CanIHazCancelationTokenSample
{
    class Program
    {
        ...
        public async void AsyncVoidWithoutCancellationToken(System.Threading.CancellationToken cancellationToken = default)
        {
            await Task.Delay(100, CancellationToken.None);
        }

        public async Task AsyncTaskWithoutCancellationToken(System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        public ValueTask<int> NonAsyncValueTaskWithoutCancellationToken(System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        public async Task<int> AsyncGenericTaskWithOptionalCancellationToken(CancellationToken cancellationToken = default)
        {
            await Task.Delay(100, System.Threading.CancellationToken.None);
            return 42;
        }
        ...
        public async ValueTask<int> AsyncValueTaskWithOptionalCancellationToken(CancellationToken cancellationToken = default)
        {
            await Task.Delay(100, System.Threading.CancellationToken.None);
            return 42;
        }

        public ValueTask<int> NonAsyncValueTaskWithOptionalCancellationToken(System.Threading.CancellationToken cancellationToken = default,System.Threading.CancellationToken cancellationToken2 = default)
        {
